...
if (!region || !region.districts.includes(districtName) || (neighborhoodName && !neighborhoods.includes(neighborhoodName))) {
  ...
  detailContent.innerHTML = `
    <section class="detail-hero record-detail-hero"><div class="city-container"><p class="detail-crumb"><a href="./">내신 대비 과외</a> / ${regionName} / <a href="${createDistrictUrl(regionName, districtName)}">${districtName}</a>${neighborhoodName ? ` / ${neighborhoodName}` : ''}</p><span class="detail-badge">${title} 내신 과외</span><h1><span>${areaLabel}</span><br />내신 대비 과외</h1><p>${title} 중학생과 고등학생을 대상으로 학교 진도와 시험 범위, 현재 성적에 맞춘 1:1 내신 과외를 진행합니다. 검정고시 지도 경험을 바탕으로 부족한 교과 기초를 보완하고, 재학생에게 필요한 학교 시험과 수행평가까지 체계적으로 관리합니다.</p><div class="city-actions" style="margin-top: 28px;"><a class="city-button record-primary" href="../#contact">${areaLabel} 내신 과외 상담</a><a class="city-button record-secondary" href="tel:01029283614">전화 상담 010-2928-3614</a></div><div class="detail-points record-detail-points"><div class="detail-point"><strong>학교별 맞춤</strong><span>교과서 · 부교재 · 학교 프린트</span></div><div class="detail-point"><strong>시험 관리</strong><span>서술형 · 수행평가 · 오답 정리</span></div></div></div></section>
    <section class="city-section city-guide-section record-guide-section"><div class="city-container"><img class="city-guide-image" src="../[복사본] 과외랜딩페이지.jpg" alt="전 과목 맞춤형 1대1 과외와 내신 및 수능 대비 학습을 안내하는 이미지" loading="lazy" /></div></section>
