...
if (!region || !region.districts.includes(districtName)) {
  ...
  document.getElementById('pageDescription').content = `${title} 검정고시 맞춤 코칭 안내. 국어, 수학, 영어 등 전 과목 방문·화상 수업 상담을 제공합니다.`;
  detailContent.innerHTML = `
    <section class="detail-hero">
      <div class="city-container">
        <p class="detail-crumb"><a href="./">지역별 안내</a> / ${regionName}</p>
        <span class="detail-badge">${regionName} 지역 맞춤 안내</span>
        <h1><span>${districtName}</span> 검정고시<br />맞춤 코칭</h1>
        <p>${title}에서 검정고시를 준비하고 있다면, 현재 학습 수준과 목표 점수에 맞춰 가장 필요한 과목부터 설계해드립니다. 방문 수업과 화상 수업 중 편한 방식으로 상담을 시작하세요.</p>
        <div class="city-actions" style="margin-top: 28px;"><a class="city-button primary" href="../#contact">${districtName} 무료 상담 신청</a><a class="city-button secondary" href="tel:01029283614">전화 상담 010-2928-3614</a></div>
    ...
    <section class="city-cta"><div class="city-container city-cta-inner"><div><h2>${districtName} 검정고시, 오늘 진단해보세요.</h2><p>학생의 현재 상황을 알려주시면 가능한 수업 방식과 학습 계획을 안내드립니다.</p></div><div class="city-actions"><a class="city-button primary" href="../#contact">무료 상담 신청</a><a class="city-button secondary" href="./">다른 지역 보기</a></div></div></section>`;
}
