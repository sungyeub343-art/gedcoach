...
if (!region || !region.districts.includes(districtName) || (neighborhoodName && !neighborhoods.includes(neighborhoodName))) {
  ...
  detailContent.innerHTML = `
    ...
    <section class="city-section city-guide-section"><div class="city-container"><img class="city-guide-image" src="../[복사본] 검정고시_이미지.jpg" alt="검정고시 대상, 과목, 일정, 시험 시간표, 수업 방식과 후기를 안내하는 이미지" loading="lazy" /></div></section>
